...
if (isset($_POST['submit'])) {
    ...
    $sql = "SELECT * FROM patient WHERE (Email = :email OR ContactNum = :contact) LIMIT 1";
    ...
    if ($stmt->rowCount() > 0) {
        ...
        if (password_verify($password, $user['Password'])) {
            ...
            header("Location: ./patient/dashboard-patient.php");
            exit();
        } else {
...
<div class="container">
    <div class="login-box">
        ...
        <h3 class="text-center text-primary mb-4">Login as Patient</h3>
        ...
        <div class="mt-1 text-center">
            ...
            <p>Not yet a member? <a href="register-patient.php" class="signup-link">Sign up</a></p>
        </div>
    </div>
</div>
