        ...
        <div class="collapse navbar-collapse" id="navbarContent">
          <ul class="navbar-nav ms-auto mb-2 mb-lg-0 align-items-center">
            ...
            <ul class="dropdown-menu" aria-labelledby="blogsDropdown">
                <li><a class="dropdown-item" href="#">Current Medical Record</a></li>
                <li><a class="dropdown-item" href="med-history.php">Medical History</a></li>
            </ul>
            </li>

            <!-- PATIENT APPOINTMENT Dropdown -->
            <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="doctorsDropdown">
                <li><a class="dropdown-item" href="appointment-patient.php">Make an Appointment</a></li>
                <li><a class="dropdown-item" href="manage-appointment-patient.php">Manage my Appointment</a></li>
            </ul>
            </li>


            <li class="nav-item">
              <a class="nav-link" href="../patient/messages-patient.php">MESSAGES</a>
            </li>
            <li class="nav-item">
