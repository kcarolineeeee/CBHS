...
if (isset($_POST['submit'])) {
    ...
    $sql = "SELECT * FROM doctor WHERE (Email = :email OR ContactNum = :contact) LIMIT 1";
...
<div class="container">
    <div class="login-box">
        <h3 class="text-center text-primary mb-4">Login as Doctor</h3>
        ...
        <div class="mt-1 text-center">
            ...
            <p>Not yet a member? <a href="register-doctor.php" class="signup-link">Sign up</a></p>
        </div>
    </div>
</div>
